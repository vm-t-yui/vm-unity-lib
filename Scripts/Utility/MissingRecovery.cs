...
public class MissingRecovery : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        else
        {
            ...
            {
                maxHit = list[0].Value;
                EditorGUILayout.LabelField("もしかして", EditorStyles.largeLabel);
            ...
            {
                EditorGUI.indentLevel--;
                otherFoldout = EditorGUILayout.Foldout(otherFoldout, "その他");
                EditorGUI.indentLevel++;
            }
            ...
            propFoldout = EditorGUILayout.Foldout(propFoldout, "保存されているプロパティ");
